const PartnershipL1PartnershipManagerFrameworkTheEcosystemArchitect = () => {
  return (
    <iframe
      ...
      title="Partnership - L1 - Partnership-Manager-Framework-The-Ecosystem-Architect"
    />
  );
};

export default PartnershipL1PartnershipManagerFrameworkTheEcosystemArchitect;
