const SalesL1BusinessDevelopmentRepresentativeFrameworkRoleDefinition = () => {
  return (
    <iframe
      ...
      title="Sales - L1- Business-Development-Representative-Framework-Role-Definition"
    />
  );
};

export default SalesL1BusinessDevelopmentRepresentativeFrameworkRoleDefinition;
