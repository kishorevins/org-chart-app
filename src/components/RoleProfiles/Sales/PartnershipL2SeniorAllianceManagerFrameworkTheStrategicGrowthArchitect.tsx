const PartnershipL2SeniorAllianceManagerFrameworkTheStrategicGrowthArchitect = () => {
  return (
    <iframe
      ...
      title="Partnership - L2 - Senior-Alliance-Manager-Framework-The-Strategic-Growth-Architect"
    />
  );
};

export default PartnershipL2SeniorAllianceManagerFrameworkTheStrategicGrowthArchitect;
