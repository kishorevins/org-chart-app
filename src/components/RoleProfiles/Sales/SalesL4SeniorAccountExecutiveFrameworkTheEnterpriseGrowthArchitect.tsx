const SalesL4SeniorAccountExecutiveFrameworkTheEnterpriseGrowthArchitect = () => {
  return (
    <iframe
      ...
      title="Sales - L4 - Senior-Account-Executive-Framework-The-Enterprise-Growth-Architect"
    />
  );
};

export default SalesL4SeniorAccountExecutiveFrameworkTheEnterpriseGrowthArchitect;
